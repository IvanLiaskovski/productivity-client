...
const GlobalError = ({ error, resetErrorBoundary }) => {
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0">
      <div className="flex w-full flex-col items-center text-center lg:w-1/2 lg:px-2 xl:px-0">
        <p className="mt-2 text-4xl font-bold tracking-wider text-gray-300 md:text-5xl lg:text-6xl">
          Error
        </p>
        <p className="mt-8 text-lg text-gray-500 md:text-xl lg:text-2xl">
          Whoops, something went wrong:
        </p>
        <p className="mb-8 text-lg text-gray-500 md:text-xl lg:text-2xl">
          {error.toString()}
        </p>
        <Button
          onClick={resetErrorBoundary}
          className="max-w-[280px] hover:opacity-90"
        >
          Try again
        </Button>
      </div>
